...
gdjs.Scene9Code.mapOfGDgdjs_9546Scene9Code_9546GDtexObjects1Objects = Hashtable.newFrom({"tex": gdjs.Scene9Code.GDtexObjects1});
...
gdjs.Scene9Code.asyncCallback9544276 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(1), (runtimeScene) => (gdjs.Scene9Code.asyncCallback9544276(runtimeScene, asyncObjectsList)));
}
}
...
gdjs.Scene9Code.asyncCallback9545444 = function (runtimeScene, asyncObjectsList) {
...
{
const asyncObjectsList = new gdjs.LongLivedObjectsList();
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.5), (runtimeScene) => (gdjs.Scene9Code.asyncCallback9545444(runtimeScene, asyncObjectsList)));
}
}
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.evtTools.input.cursorOnObject(gdjs.Scene9Code.mapOfGDgdjs_9546Scene9Code_9546GDtexObjects1Objects, runtimeScene, true, false);
if (isConditionTrue_0) {
isConditionTrue_0 = false;
