...
gdjs.Scene7Code.asyncCallback9516340 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(6), (runtimeScene) => (gdjs.Scene7Code.asyncCallback9516340(runtimeScene, asyncObjectsList)));
}
}
...
gdjs.Scene7Code.asyncCallback9517492 = function (runtimeScene, asyncObjectsList) {
...
{
const asyncObjectsList = new gdjs.LongLivedObjectsList();
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.5), (runtimeScene) => (gdjs.Scene7Code.asyncCallback9517492(runtimeScene, asyncObjectsList)));
}
}
