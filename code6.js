...
gdjs.Scene7Code.asyncCallback7842828 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(6), (runtimeScene) => (gdjs.Scene7Code.asyncCallback7842828(runtimeScene, asyncObjectsList)));
}
}
...
gdjs.Scene7Code.asyncCallback7844476 = function (runtimeScene, asyncObjectsList) {
...
{
const asyncObjectsList = new gdjs.LongLivedObjectsList();
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.5), (runtimeScene) => (gdjs.Scene7Code.asyncCallback7844476(runtimeScene, asyncObjectsList)));
}
}
