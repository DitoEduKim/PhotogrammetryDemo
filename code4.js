...
gdjs.Scene5Code.asyncCallback8392308 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(4), (runtimeScene) => (gdjs.Scene5Code.asyncCallback8392308(runtimeScene, asyncObjectsList)));
}
}
...
gdjs.Scene5Code.asyncCallback8938780 = function (runtimeScene, asyncObjectsList) {
...
{
const asyncObjectsList = new gdjs.LongLivedObjectsList();
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.5), (runtimeScene) => (gdjs.Scene5Code.asyncCallback8938780(runtimeScene, asyncObjectsList)));
}
}
